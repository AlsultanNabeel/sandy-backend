...
BRAINSTORM_TOOLS = [
    {
        ...
        "description": (
            ...
            "«بدي أنظّم أفكاري حول...» أو «ساعديني أخطّط لـ...». "
    ...
    },
    {
        "name": "brainstorm_add",
        "description": (
            "سجّلي كل نقطة جديدة بجلسة العصف عشان ما ينساها التلخيص — "
            "«عندي مهارة كذا أضيفها»، «ذكّريني أبعت كذا»."
        ),
        "parameters": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": (
            "أنهي جلسة العصف واحفظي خطة كاملة — «لخّصي»، «خلصنا»، «طلّعيلي الخطة»."
        ),
    ...
    },
    {
        ...
        "description": (
            "ألغي جلسة العصف بدون حفظ — «ألغي العصف»، «بطّلي»، «اطلعي من وضع العصف»."
        ),
        "parameters": {"type": "object", "properties": {}, "required": []},
    ...
    },
    {
        ...
        "description": "خطط العصف المحفوظة — «شو خططي؟»",
        "parameters": {"type": "object", "properties": {}, "required": []},
        "handler": brainstorm_list,
    },
    {
        "name": "brainstorm_show",
        "description": "اعرضي خطة محفوظة — «ورجيني خطة كذا»",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": (
            "عدّلي خطة محفوظة — «ضيف بند كذا لخطة اللينكدإن»، «احذفي خطوة كذا». "
            "بتقترح وبتستنى brainstorm_confirm."
        ),
        "parameters": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": (
            "احذفي خطة محفوظة — «احذفي خطة كذا». بتقترح وبتستنى brainstorm_confirm."
        ),
        "parameters": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": (
            "نفّذي حذف/تعديل خطة اقترحتيه قبل شوي بعد تأكيده — «آه»، «أكّدي»، «تمام نفّذي»."
        ),
        "parameters": {"type": "object", "properties": {}, "required": []},
