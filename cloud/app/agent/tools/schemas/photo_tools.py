...
الحفظ بيصير عند الرفع من التطبيق (photos_api) — مش هون.
"""
...
PHOTO_TOOLS = [
    {
        "name": "save_photo",
        "description": (
            "احفظي آخر صورة بعتها المستخدم بالألبوم — «احفظي هاي الصورة»، "
            "«خزّنيها»، «احفظيها باسم كذا»."
        ),
        "parameters": {
            "type": "object",
            "properties": {
    ...
    },
    {
        "name": "show_photo",
        "description": (
            "اعرضي صورة محفوظة من الألبوم — «ورجيني صورة العائلة»، "
            "«الصورة اللي بعتها امبارح»."
        ),
        "parameters": {
            "type": "object",
            "properties": {
    ...
    },
    {
        "name": "list_photos",
        "description": (
            "قائمة الصور المحفوظة بالألبوم — «شو الصور المحفوظة؟»، «كم صورة عندي؟»."
        ),
        "parameters": {
            "type": "object",
            "properties": {
