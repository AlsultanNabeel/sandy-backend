...
# نافذة الأرضية: أهدأ لحظة خلال آخر تلات ثواني تقريباً (الإطار ~مية وتلاتين
# جزء من الألف). ومنستنى شوية إطارات قبل ما نصدّقها — قبلها منستعمل الحد الأدنى.
_VAD_FLOOR_FRAMES = 24
