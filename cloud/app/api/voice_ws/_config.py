...
#
# `SANDY_APP_TURNS=ours` بيرجّع الكاشف القديم **بلا بناء تطبيق**: السيرفر بيقول
# للتطبيق بالمصافحة إذا يفتح المايك وهي بتحكي، فالتراجع كله من إعدادات هيروكو.
_APP_TURNS_BY_GEMINI: bool = os.getenv("SANDY_APP_TURNS", "gemini").strip().lower() != "ours"
_APP_SILENCE_MS = 900
_APP_PREFIX_MS = 300
