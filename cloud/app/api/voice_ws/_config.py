...
_VAD_FLOOR_MS = float(os.getenv("SANDY_VAD_FLOOR_MS", "3000"))
...
_VAD_ROOM_MS = float(os.getenv("SANDY_VAD_ROOM_MS", "30000"))
_VAD_STUCK_MS = float(os.getenv("SANDY_VAD_STUCK_MS", "3000"))
...
_VAD_ROOM_MAX = float(os.getenv("SANDY_VAD_ROOM_MAX", "600"))
...
_VAD_MAX_UTTER_MS = float(os.getenv("SANDY_VAD_MAX_UTTER_MS", "15000"))
...
_BARGE_MIN_MS = 1200
# سقف لعدد الإطارات المحجوزة قبل ما نقرّر إنها مقاطعة — ثانيتين تقريباً، كفاية
# للجملة اللي بدها تقاطع، وما بتخلّي الذاكرة تكبر لو الغرفة ضجّة متواصلة.
_HELD_FRAMES_MAX = 16
