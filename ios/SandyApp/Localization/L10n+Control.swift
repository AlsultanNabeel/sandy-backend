...
enum L10nControl {
    ...
    static let table = L10nTable(
        ar: [
            ...
            "node.presenceHeader": .text("بعرض رمز من ستّ أرقام ع شاشتي. اكتبه هون."),
            "node.presenceField":  .text("الرمز اللي ع شاشتي"),
            "node.presenceSubmit": .text("تأكيد"),
            "node.presenceResend": .text("ابعت رمز جديد"),
            "node.presenceHint":   .text("الرمز بيضل خمس دقايق."),
            "node.presenceNotSent": .text("ما قدرت أوصل للوحدة. تأكد إنها شغّالة وع الواي فاي، وبعدين ابعت رمز جديد."),
            "node.presenceWrong":  .text("الرمز مش مطابق. قارنه باللي ع شاشتي."),
            "node.presenceExpired": .text("الرمز انتهى. ابعت رمز جديد."),
            "node.alreadyClaimed": .text("هاي الوحدة مربوطة بحساب تاني. لازم تنعمل إعادة ضبط المصنع أول."),
            "node.tooMany":        .text("محاولات كتير. استنّى شوي وجرّب."),
        ...
        en: [
            ...
            "node.presenceHeader": .text("I'm showing a six-digit code on my screen. Type it here."),
            "node.presenceField":  .text("The code on my screen"),
            "node.presenceSubmit": .text("Confirm"),
            "node.presenceResend": .text("Send a new code"),
            "node.presenceHint":   .text("The code lasts five minutes."),
            "node.presenceNotSent": .text("I couldn't reach the node. Make sure it's on and on Wi-Fi, then send a new code."),
            "node.presenceWrong":  .text("That code doesn't match. Compare it with my screen."),
            "node.presenceExpired": .text("That code expired. Send a new one."),
            "node.alreadyClaimed": .text("This node belongs to another account. It needs a factory reset first."),
            "node.tooMany":        .text("Too many attempts. Wait a moment and try again."),
