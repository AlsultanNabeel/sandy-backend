...
enum L10nHome {
    ...
    static let table = L10nTable(
        ar: [
            ...
            "title":            .text("ساندي"),
            "profile":          .text("حسابي"),
            "block.quickAdd":   .text("إضافة سريعة"),
            "block.weather":    .text("الطقس"),
            "block.robotBody":  .text("جسم ساندي"),
            "block.homeControl": .text("التحكّم بالبيت"),
        ...
        en: [
            ...
            "block.quickAdd":   .text("Quick add"),
            "block.weather":    .text("Weather"),
            "block.robotBody":  .text("Sandy's body"),
            "block.homeControl": .text("Home control"),
