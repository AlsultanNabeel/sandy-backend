...
// **نبدأ بالأكبر، مش بالمناسب.**
//
// المخزن بينحجز مرّة وقت تشغيل المستشعر بحجم هالدقّة. والتصغير بعدين بيشتغل
// دايمًا — بس التكبير لأ: بيطلب مخزنًا أكبر من المحجوز، فبيفشل.
//
// وهاد اللي كان بيصير بالحرف: `96x96` و`cif` بينجحوا، و`uxga` و`sxga` و`hd`
// بيفشلوا — والمستشعر بيبيّن سليمًا (`cam=yes`) لأنه فعلًا سليم، بس محبوس
// بحجم انحجزله أول مرّة.
//
// الحجز الأكبر بياخد رامًا إضافية، وهي موجودة: اللوح عنده أربع ميجا حرّة.
#define CAMERA_DEFAULT_FRAME_SIZE FRAMESIZE_UXGA   // 1600x1200 — السقف، وبنصغّر منه
